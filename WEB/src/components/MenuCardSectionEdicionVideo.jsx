...
export default function MenuCardSectionEdicionVideo() {
    return (
        <>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4 p-2">
                <BookingCard
                    imagen="https://plus.unsplash.com/premium_photo-1664302522743-2fba3439ea1b?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    title="WoorPress"
                    ranking="2.0"
