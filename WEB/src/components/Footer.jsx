...
export function Footer() {
  return (
    <footer className="relative w- md:w-auto">
      <div className="mx-auto w-full px-8 bg-gradient-to-br from-primary to-secondary">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2 border-2 border-red-500">
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="https://material-tailwind.com/">WebApp Tutorias/Cursos</a>. All
            Rights Reserved.
          </Typography>
