...
export function ProfileMenu({ userData }) {
  let navigate = useNavigate();
  const { user, logout } = useUser();

  const goToProfile = () => {
    navigate('/profile', { replace: true }); // Llamar a navigate con la ruta '/profile'
  };
  return (
    <Menu>
      <MenuHandler>
      ...
      <MenuList  >
        <MenuItem className="flex items-center gap-2 bg-gradient-to-br from-primary to-secondary" onClick={goToProfile}>
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
        ...
        <MenuItem className="flex items-center gap-2 bg-gradient-to-br from-primary to-secondary">
          <svg
            width="14"
            height="14"
            viewBox="0 0 14 14"
        ...
        <MenuItem className="flex items-center gap-2 bg-gradient-to-br from-primary to-secondary" onClick={logout}>
          <svg
            width="16"
            height="14"
            viewBox="0 0 16 14"
